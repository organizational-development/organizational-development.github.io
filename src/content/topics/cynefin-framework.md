...
Dave Snowden's Cynefin (Welsh, roughly "habitat"; pronounced *kuh-NEV-in*) is a
sense-making framework, not a categorization framework. It helps a group decide
what *kind* of situation they are in, and therefore what kind of response is
appropriate.
...
Do not use when: you want to classify things into permanent boxes. Domains are
situational and move.
...
5. **Confused** (formerly Disorder): you do not know which domain you are in.
   ...
   method from their own preferred domain.


## The central lesson for OD

**Culture change, leadership behavior, and most organizational change are
Complex, and are routinely managed as if they were Complicated.**
...
response to a complex domain is a portfolio of small, parallel, safe-to-fail
experiments with fast feedback.


## Safe-to-fail experiment design

An experiment needs, written down in advance:

* A coherent hypothesis about why it might work.
* A way to tell early if it is working (amplify) or not (dampen).
* A stop condition and a means to reverse it.
* A blast radius small enough that failure is survivable and non-newsworthy.


## Examples by audience

* **Health care**: sepsis protocol compliance is Complicated — analyzable, with
  a right answer. Improving team communication across a merged department is
  Complex — try three approaches on three wards, keep what emerges.

* **Software**: a production outage begins Chaotic (act to stabilize), becomes
  Complicated during root cause analysis, and the prevention work is Complex.
...
* Easily reduced to a 2x2 and misused as a static classification.
* Domain boundaries are contested in practice; two competent people can
  disagree, though the disagreement is usually productive.
* Weak on how to move a system deliberately from Complex toward Complicated.


## Questionnaire

A paired, copy-and-use diagnostic instrument for this model:
[cynefin-framework-questionnaire](../cynefin-framework-questionnaire/).
