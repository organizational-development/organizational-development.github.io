...
OD is unusual among management disciplines in having an explicit value base. The
founding tradition holds that organizations should be humane as well as
effective, that people affected by a decision should have a voice in it, and
that the practitioner's obligation runs to the whole system, not only to the
person paying.

This creates real conflicts. The chapter exists to make them visible rather than
...
* **Consent under power asymmetry.** An employee invited to a "voluntary"
  ...
  opt-out, and never report participation lists.

* **Surveys as extraction.** Asking people about problems you have no intent or
  authority to fix is harmful. It reliably lowers trust below the pre-survey
  baseline. Do not run a survey you cannot act on.

* **Confidentiality vs. duty to disclose.** Some findings cannot be held in
  confidence: patient safety risk, harassment, fraud, regulatory breach. State
  these exceptions before every interview, not after one occurs.
...
* **Anonymity that is not anonymous.** Demographic cuts on small teams
  ...
  responses, and hold it even when an executive pushes.

* **OD as a euphemism.** Being asked to run "culture work" that is preparation
  for redundancies, or "engagement" that is a legal defense, is common. You may
  choose to take such work; you may not pretend it is something else to the
  participants.

* **Manufactured consent.** Consultation theater — running sessions after the
...
* **Health care**: a staff survey that surfaces a named consultant's behavior
  cannot be aggregated away. There is a patient-safety duty. Plan the route for
  such disclosures before you collect anything.
...
* **Executive**: the ethical test for a leadership team is whether it will hear
  ...
  decide in advance what happens if the answer is no.


## A practical test

Before acting, ask: would I be comfortable if every participant read the full
contract, the raw method, and the report to the sponsor? If not, something needs
to change — usually the contract.
