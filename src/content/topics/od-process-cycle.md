...
supported indirectly by the poor track record of intervention-first programs,
and by the survey feedback studies described in
...
3. **Diagnosis**: gather data through interviews, observation, surveys,
   documents, and system telemetry. Choose a diagnostic model to organize what
   you gather. See [mckinsey-7s-framework](../mckinsey-7s-framework/),
   [burke-litwin-causal-model](../burke-litwin-causal-model/),
   [weisbord-six-box-model](../weisbord-six-box-model/).

4. **Feedback**: give the data back to the people it came from, before you give
   it to the sponsor. This is an OD value, not merely a courtesy: the people in
   the system are the ones who must act on it, and they will correct your
   misreadings. See [survey-feedback-method](../survey-feedback-method/).

5. **Planning**: convert diagnosis into hypotheses, and hypotheses into
   interventions with named owners, dates, and measures. State what you expect
   to change and by when, in advance.
...
8. **Institutionalization or exit**: make the change survive the sponsor's
   departure, or wind the effort down honestly. Changes that depend on one
   enthusiastic person are not changes; they are that person.


## The rule that matters most

Diagnose before you intervene. The most common failure in the field is the
intervention-first program: a reorganization, an offsite, a values launch, or a
tool rollout selected before anyone established what was wrong. Intervention
first is expensive, it burns the organization's willingness to try again, and it
teaches people that improvement efforts are theater.
...
* **Executive**: a CEO reports "we lack accountability". Diagnosis finds
  overlapping decision rights across three executives and no forum where
  tradeoffs are resolved. Accountability is an effect, not a cause.
...
* [action-research](../action-research/) — the underlying research logic.
